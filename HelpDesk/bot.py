...
async def run_bot(
    ...
    if bot_params and "elevenlabs_api_key" in bot_params:
        elevenlabs_api_key = bot_params["elevenlabs_api_key"]
    if bot_params and "elevenlabs_voice_id" in bot_params:
        elevenlabs_voice_id = bot_params["elevenlabs_voice_id"]
